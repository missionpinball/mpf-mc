    ...
    def _display_created(self, *args) -> None:
        ...
        try:
            if self.config['default']:
                ...
                elif 'default' in self.mc.targets:
                    raise AssertionError('Multiple displays have been set as the default. Please choose a single display to default to (\"{}\" is currently set as the default).'.format(self.mc.targets['default'].name))
        except KeyError:
            pass
