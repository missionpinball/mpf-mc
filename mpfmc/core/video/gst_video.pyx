...
# ---------------------------------------------------------------------------
#    GStreamer definitions (needed for Cython language)
# ---------------------------------------------------------------------------
cdef extern from 'gst/gst.h':
    ...
    void g_signal_emit_by_name(gpointer instance, const_gchar *detailed_signal, void *retvalue)
    ...
    GstElement *gst_parse_bin_from_description (const_gchar *bin_description,
                                                gboolean ghost_unlinked_pads,
                                                GError **err)


# ---------------------------------------------------------------------------
#    Custom C helper function declarations used by the player using
#    GStreamer library (needed for Cython language)
# ---------------------------------------------------------------------------
cdef extern from 'gst_video.h':
    ...
    void c_appsink_pull_preroll(GstElement *appsink,
            appcallback_t callback, void *userdata, int alpha_channel) nogil
...
# ---------------------------------------------------------------------------
#    Prevent GStreamer crash when some players are still working.
# ---------------------------------------------------------------------------
