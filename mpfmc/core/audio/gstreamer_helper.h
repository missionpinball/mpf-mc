...
static void g_object_set_bool(GstElement *element, char *name, gboolean value)
{
	g_object_set(G_OBJECT(element), name, value, NULL);
}

static void g_object_set_char(GstElement *element, char *name, char *value)
{
	g_object_set(G_OBJECT(element), name, value, NULL);
}

static void g_object_set_element(GstElement *element, char *name, GstElement *value)
{
    g_object_set(G_OBJECT(element), name, value, NULL);
}
